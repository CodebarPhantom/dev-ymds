...
- [x] 1. Buat migrasi database dan enum
...
- [ ] 2. Buat Model Eloquent
  - [x] 2.1 Buat model `PurchaseRequest`
...
- [x] 3. Buat PurchaseRequestPolicy dan daftarkan permission
...
- [ ] 4. Implementasikan PurchaseRequestService — core CRUD dan nomor pengajuan
  - [x] 4.1 Buat `App\Services\PurchaseRequestService` (extend MasterService)
  ...
  - [x] 4.2 Tulis property test untuk auto-fill invariant (Property 1)
    - **Property 1: New PurchaseRequest Auto-Fill Invariant**
    - **Validates: Requirements 1.2, 1.3, 1.4**

  - [x] 4.3 Tulis property test untuk nomor pengajuan format dan keunikan (Property 2)
    - **Property 2: Nomor Pengajuan Format dan Keunikan**
    - **Validates: Requirements 1.5, 11.1, 11.2, 11.3, 11.4**

  - [x] 4.4 Tulis property test untuk computed fields invariant (Property 4)
...
- [ ] 5. Implementasikan PurchaseRequestService — state machine (submit, cancel, approve, reject)
  - [x] 5.1 Implementasikan method `submit`, `cancel`, `approve`, `reject` di PurchaseRequestService
  ...
  - [x] 5.2 Tulis property test untuk submit state transition (Property 6)
    - **Property 6: Submit State Transition**
    - **Validates: Requirements 3.1, 3.2, 3.5**

  - [x] 5.3 Tulis property test untuk approval log invariant (Property 7)
    - **Property 7: Approval Log Invariant**
    - **Validates: Requirements 3.3, 4.3, 4.4, 5.3, 5.4, 6.2, 6.4, 7.3**

  - [x] 5.4 Tulis property test untuk Bendahara approval state transition (Property 8)
    - **Property 8: Bendahara Approval State Transition**
    - **Validates: Requirements 4.1, 4.2, 4.5, 4.6**

  - [x] 5.5 Tulis property test untuk Ketua approval state transition (Property 9)
    - **Property 9: Ketua Approval State Transition**
    - **Validates: Requirements 5.1, 5.2, 5.5, 5.6**

  - [x] 5.6 Tulis property test untuk cancel state transition dan otorisasi (Property 12)
    - **Property 12: Cancel State Transition dan Otorisasi**
    - **Validates: Requirements 7.1, 7.2, 7.4, 7.5, 7.6**

  - [x] 5.7 Tulis property test untuk CANCELLED sebagai terminal state (Property 13)
...
- [ ] 7. Implementasikan PurchaseRequestService — proses pembelian (Sarpras)
  - [x] 7.1 Implementasikan method `startPurchasing` dan `markItemPurchased` di PurchaseRequestService
  ...
  - [x] 7.2 Tulis property test untuk purchasing state transitions (Property 10)
    - **Property 10: Purchasing State Transitions**
    - **Validates: Requirements 6.1, 6.5, 6.6, 6.8, 6.9**

  - [x] 7.3 Tulis property test untuk total biaya aktual invariant (Property 11)
    - **Property 11: Total Biaya Aktual Invariant**
    - **Validates: Requirements 6.7**

- [x] 8. Implementasikan PurchaseRequestService — datatable query
  ...
  - [x] 8.1 Tulis property test untuk role-based data visibility (Property 14)
    - **Property 14: Role-Based Data Visibility**
    - **Validates: Requirements 8.1, 9.1, 12.1, 12.2**

  - [x] 8.2 Tulis property test untuk filter datatable konsistensi (Property 15)
    - **Property 15: Filter Datatable Konsistensi**
    - **Validates: Requirements 9.2**

- [x] 9. Buat validasi input (Form Request / inline validation)
  ...
  - [x] 9.1 Tulis property test untuk validasi input item (Property 3)
    - **Property 3: Validasi Input Item**
    - **Validates: Requirements 1.8, 1.9, 6.10**

  - [x] 9.2 Tulis property test untuk edit permission berdasarkan status (Property 5)
    - **Property 5: Edit Permission Berdasarkan Status**
    - **Validates: Requirements 2.4, 2.5**

- [ ] 10. Buat API Controllers
  - [x] 10.1 Buat `Api\V1\PurchaseRequest\PurchaseRequestController`
  ...
  - [x] 10.2 Buat `Api\V1\PurchaseRequest\PurchaseRequestApprovalController`
  ...
  - [x] 10.3 Buat `Api\V1\PurchaseRequest\PurchaseRequestPurchasingController`
...
- [ ] 11. Buat Web Controllers
  - [x] 11.1 Buat `Web\PurchaseRequest\PurchaseRequestController`
  ...
  - [x] 11.2 Daftarkan routes web dan API di routes/web.php dan routes/api.php
...
- [ ] 12. Buat Blade Views — index dan create/edit
  - [x] 12.1 Buat `resources/views/purchase-request/index.blade.php`
  ...
  - [x] 12.2 Buat `resources/views/purchase-request/create.blade.php`
...
- [x] 14. Tambahkan menu entry di config/menus.php
...
- [x] 16. Implementasikan DashboardPurchaseRequestService
  ...
  - [x] 16.1 Tulis property test untuk dashboard summary konsistensi (Property 16)
...
- [ ] 17. Buat API Dashboard Controller dan Web Dashboard Controller
  - [x] 17.1 Buat `Api\V1\PurchaseRequest\PurchaseRequestDashboardController`
  ...
  - [x] 17.2 Buat `Web\PurchaseRequest\PurchaseRequestDashboardController`
  ...
  - [x] 17.3 Buat `resources/views/purchase-request/dashboard.blade.php`
...
- [ ] 18. Implementasikan Export Excel
  - [x] 18.1 Buat `App\Exports\PurchaseRequestHeaderSheet` (implement FromQuery, WithHeadings, WithMapping, WithTitle)
  ...
  - [x] 18.2 Buat `App\Exports\PurchaseRequestItemSheet` (implement FromQuery, WithHeadings, WithMapping, WithTitle)
  ...
  - [x] 18.3 Buat `App\Exports\PurchaseRequestExport` (implement WithMultipleSheets)
  ...
  - [x] 18.4 Buat `Web\PurchaseRequest\PurchaseRequestExportController`
  ...
  - [x] 18.5 Tulis property test untuk export data completeness dan role isolation (Property 17)
    - **Property 17: Export Data Completeness dan Role Isolation**
    - **Validates: Requirements 13.36, 13.37, 13.45, 13.46**

- [x] 19. Final Checkpoint — Pastikan semua test lulus
  - Pastikan semua test lulus, tanyakan kepada user jika ada pertanyaan.
